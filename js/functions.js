...
const isMeetinginWorkingHours = (workingStartTime, workingEndTime, meetingStartTime, meetingTime) => {
  ...
  const startMinutes = timeStringToMinutes(workingStartTime);
  const endMinutes = timeStringToMinutes(workingEndTime);
  const meetingStartminutes = timeStringToMinutes(meetingStartTime);
...
console.log(isMeetinginWorkingHours('08:00', '17:30', '14:00', 90));
console.log(isMeetinginWorkingHours('8:0', '10:0', '8:0', 120));
console.log(isMeetinginWorkingHours('08:00', '14:30', '14:00', 90));
console.log(isMeetinginWorkingHours('14:00', '17:30', '08:0', 90));
console.log(isMeetinginWorkingHours('8:00', '17:30', '08:00', 900));
